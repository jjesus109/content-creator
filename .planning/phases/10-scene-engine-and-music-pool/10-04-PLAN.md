...
INTEGRATION NOTE: This plan (04) tests MusicMatcher in isolation using mock Supabase data. MusicMatcher
does NOT directly depend on Plan 02 (SceneEngine/scene mood) at test time — tests use hardcoded mood
strings. The actual integration between Plan 02 scene mood output and MusicMatcher.pick_track(mood) is
wired in Plan 05 (daily_pipeline.py). Plan 05 depends on both this plan and Plan 02.
</objective>
