...
- **Global scope**: `/Users/jesusalbino/Projects/content-creation/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jesusalbino/Projects/content-creation/.claude/notes/`)
...
2. Glob `/Users/jesusalbino/Projects/content-creation/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jesusalbino/Projects/content-creation/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jesusalbino/Projects/content-creation/.claude/notes/` — works in any directory
