...
- Usage: Reference from command with `@/Users/jesusalbino/Projects/content-creation/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/jesusalbino/Projects/content-creation/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/jesusalbino/Projects/content-creation/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
